...
def check_guess(guess):
    ...
    if (guess_to_lowercase.isalpha() == True) and (word.__contains__(guess_to_lowercase) == True): print(f"Good guess! {guess_to_lowercase} is in the word: {word}")
    else: print(f"Sorry, {guess_to_lowercase} is not in the word: {word}. Try again.")
